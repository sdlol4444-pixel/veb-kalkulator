...
function novaIgra() {
  ...
  const prikazIme = materialNamesMK[randomMaterialKey]; // Cyrillic name
  ...
  if (formulaType === 0) {
    ...
    text =
      "Топлинско ширење | Материјал: " + prikazIme +
    ...
    text =
      "Електричен отпор | Материјал: " + prikazIme +
    ...
    text =
      "Топлинска спроводливост | Материјал: " + prikazIme +
    ...
    text =
      "Еластичност | Материјал: " + prikazIme +
